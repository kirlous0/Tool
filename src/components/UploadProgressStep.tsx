...
import { Loader2, CheckCircle2, AlertTriangle, RefreshCw, ArrowRight, FileText, XCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      {progress.errorMessage && (
        <div className="mb-6 p-4 rounded-xl bg-red-950/40 border border-red-800 text-red-200 text-xs flex items-start gap-3">
      ...
      {failedFiles.length > 0 && (
        <div className="bg-slate-900 border border-rose-900/50 rounded-2xl p-4 mb-6 shadow-xl">
      ...
      {progress.status === 'failed' && (
        <div className="flex justify-center mt-6">
          <button
            onClick={onRetryFailed}
            className="px-6 py-3 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-semibold text-sm transition shadow-lg shadow-rose-950/40 flex items-center gap-2"
          >
